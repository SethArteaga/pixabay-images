...
function buscarImagenes(){
    ...
    const key = '27086848-028b37768d10bdb93aa2098b5';
        ...
        resultado.innerHTML += `
            <div class="w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4">
                <div class="bg-white">
                    ...
                    <div class="p-4">
                        <p class="font-bold">${likes}<pan class="font-light"> Me Gusta</pan></p>
                        <p class="font-bold">${views}<pan class="font-light"> Veces Vista</pan></p>
